...
\033[1;37m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\033[1;34m  🌸 \033[1;33mBản Quyền Tool Thuộc:\033[1;31m REVIEWTOOL247NDK
...
def nghigiailao(o):
    while o > 0:
        o -= 1
        print(f"\033[38;5;99m🌸 [NDK][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;226m🌸 [NDK][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;207m🌸 [NDK][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
